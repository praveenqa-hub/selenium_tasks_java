...
public class VideoLinkedin {
	...
	public void videoPost() throws AWTException, InterruptedException {
		...
		// Navigate to the given URL https://www.linkedin.com/
				...
				// We have to pass path of the file using StringSelection  //Tree.mp4
				...
				// Verify that "Post successful." message is displayed 
